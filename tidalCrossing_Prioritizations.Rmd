...
knitr::opts_chunk$set(
	echo = FALSE, # set to T for outputing the code chunks in html.
	fig.height = 3,
	fig.width = 3,
	message = FALSE,
	warning = FALSE
...
The Total Ecological Benefit Score is the rescaled (1 to 5) *SUM* of the 4 ecological benefit metrics.T
...
After discovering coding bug, this submetric was reran to taking the approach of using as much data as possible for the high-water risk/lack of clearance sub-metric score.
