...
* Extract the RAW values from the **Data Sheet - SITE** sheet and perform the various calculations/lookups using R or other (ArcMap)  
...
formulas %>% filter(!str_detect(formula, "Data")) %>% View()
...
tokens <-
  ...
  select(address, row, col, formula) %>% 
...
# xlsx::write.xlsx(characters,
#                  file = "spreadsheets/extractedKey_WORKING.xlsx",
#                  sheetName = "Likely keys")
# xlsx::write.xlsx(numerics,
#                  file = "spreadsheets/extractedKey_WORKING.xlsx",
#                  sheetName = "Likely values", append = TRUE)
